...
- [2024/04/15 Study Note (OSC O-DU High I-release FCFS scheduler with RRM Policy Implementation)](#2024-04-15-study-note--osc-o-du-high-i-release-fcfs-scheduler-with-rrm-policy-implementation-)
  ...
  * [3. OSC's Data Structure Related to RRM Policy](#3-osc-s-data-structure-related-to-rrm-policy)
    ...
    + [3.2. `odu_config.xml`](#32-odu-configxml)
    + [3.3. `cell_config.xml`](#33-cell-configxml)
    + [3.4. `sch.h`](#34-schh)
    + [3.5. `common_def.h`](#35-common-defh)
    + [3.6. `mac_sch_interface.h`](#36-mac-sch-interfaceh)
    + [3.7. `du_app_mac_inf.h`](#37-du-app-mac-infh)
    + [3.8. `du_cfg.h`](#38-du-cfgh)
    + [3.9. `phy_stub.h`](#39-phy-stubh)
    + [3.10. `mac.h`](#310-mach)
    + [3.11. `sch_fcfs.h`](#311-sch-fcfsh)
